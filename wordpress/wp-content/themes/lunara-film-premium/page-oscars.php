...
$hero_copy         = function_exists( 'lunara_theme_mod_text' ) ? lunara_theme_mod_text( 'lunara_oscars_portal_copy', '' ) : '';
        ...
        <section class="lunara-home-section lunara-oscars-portal-links-section">
            <div class="lunara-home-section-header">
                <div>
                    ...
                    <?php if ( ! empty( $snapshot['winner_record'] ) ) : ?>
                        <p class="lunara-home-section-summary"><?php echo esc_html( $snapshot['winner_record'] ); ?></p>
                    <?php endif; ?>
            </div>
            ...
            <section class="lunara-home-section lunara-oscars-portal-spotlights">
                <div class="lunara-home-section-header">
                    ...
                    <?php if ( ! empty( $snapshot['summary'] ) ) : ?>
                        <p class="lunara-home-section-summary"><?php echo esc_html( $snapshot['summary'] ); ?></p>
                    <?php endif; ?>
                </div>
